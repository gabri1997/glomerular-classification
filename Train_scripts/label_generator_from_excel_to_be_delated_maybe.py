...
def transfer_labels_from_wsi_to_glomeruli(root_folder, final_dictionary, output, train_ratio=0.7, seed=42):
...
if __name__ == '__main__':
    ...
    #transfer_labels_from_wsi_to_glomeruli(root_folder, final_dictionary, output, train_ratio=0.7, seed=42)
