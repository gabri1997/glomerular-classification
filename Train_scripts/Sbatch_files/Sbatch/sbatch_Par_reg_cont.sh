...
#SBATCH --output=res_[[PAR_REGOL_CONT]].out
#SBATCH --error=res_[[PAR_REGOL_CONT]].err
#SBATCH --job-name=[[PAR_REGOL_CONT]]
...
--label PAR_REGOL_CONT --train_or_test Test_on_folds --val_loss True --scheduler SGD --weights _New22 --conf_matrix_label non-PAR_REGOL_CONT PAR_REGOL_CONT --classes 2 --wandb_flag True --wloss True --sampler False \
