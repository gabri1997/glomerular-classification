...
#SBATCH --output=res_[[GLOBAL_SEGMENTAL]].out
#SBATCH --error=res_[[GLOBAL_SEGMENTAL]].err
#SBATCH --job-name=[[GLOBAL_SEGMENTAL]]
...
--label GLOBAL_SEGMENTAL --train_or_test Test_on_folds --val_loss True --scheduler SGD --weights _New22 --conf_matrix_label SEGM GLOB --classes 2 --wandb_flag True --wloss True --sampler False \
