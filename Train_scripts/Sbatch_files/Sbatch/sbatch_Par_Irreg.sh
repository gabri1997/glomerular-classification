...
#SBATCH --output=res_[[PAR_IRREG]].out
#SBATCH --error=res_[[PAR_IRREG]].err
#SBATCH --job-name=[[PAR_IRREG]]
...
--label PAR_IRREG --train_or_test Test_on_folds --val_loss True --scheduler SGD --weights _New22 --conf_matrix_label non-PAR_IRREG PAR_IRREG --classes 2 --wandb_flag True --wloss True --sampler False \
