...
#SBATCH --output=res_[[GRAN_FINE]].out
#SBATCH --error=res_[[GRAN_FINE]].err
#SBATCH --job-name=[[GRAN_FINE]]
...
--label GRAN_FINE --train_or_test Test_on_folds --val_loss True --scheduler SGD --weights _New22 --conf_matrix_label non-GRAN_FINE GRAN_FINE --classes 2 --wandb_flag True --wloss True --sampler False \
